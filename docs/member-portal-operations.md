...
The private portal workbook has been created in the operator's Google Drive and its ID is configured in staging. A dedicated Google service account still needs to be created and shared on that workbook as Viewer before the portal can read or publish it.
